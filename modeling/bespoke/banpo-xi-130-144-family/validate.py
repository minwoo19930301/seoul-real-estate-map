...
R=pathlib.Path.cwd();P=R/'data/model-source/bespoke/banpo-xi-130-144-family';sys.path.insert(0,str(R/'scripts/bespoke'));from validate_height_regions import read_triangles,above_ceiling
A=json.loads((P.parent/'banpo-xi-all44-research/modeling-ready-101-144.json').read_text());reports=[]
for t in map(str,range(130,145)):
 p=P/t
