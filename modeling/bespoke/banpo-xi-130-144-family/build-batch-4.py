...
for t in map(str,range(139,142)):
...
(P/'scene-preservation-batch-4.json').write_text(json.dumps({'equal':before==after,'active_scene':old.name,'before':before,'after':after},indent=2))
