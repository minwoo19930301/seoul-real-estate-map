...
for t in map(str,range(133,136)):
...
(P/'scene-preservation-batch-2.json').write_text(json.dumps({'equal':before==after,'active_scene':old.name,'before':before,'after':after},indent=2))
