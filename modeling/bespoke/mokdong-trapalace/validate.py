...
assert len(owned)==6
assert 'b028f776-57de-460a-ad6f-4f0919b2d0e7' not in owned
q={'siteId':B['siteId'],'assetCount':len(res),'residentialCount':4,'households':522,'uniqueSourceOwnership':True,'unrelatedNeighborsNotClaimed':True,'assets':res,'totalBytes':sum(r['bytes'] for r in res),'totalTriangles':sum(r['triangles'] for r in res)}
