...
q={'siteId':B['siteId'],'assetCount':len(res),'residentialCount':3,'households':617,'uniqueSourceOwnership':True,'officeTowerPreserved':True,'assets':res,'totalBytes':sum(r['bytes'] for r in res),'totalTriangles':sum(r['triangles'] for r in res)}
