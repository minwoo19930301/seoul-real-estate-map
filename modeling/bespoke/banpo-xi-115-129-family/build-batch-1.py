...
for t in map(str,range(115,118)):
...
(P/'scene-preservation-batch-1.json').write_text(json.dumps({'equal':before==after,'active_scene':old.name,'before':before,'after':after},indent=2))
