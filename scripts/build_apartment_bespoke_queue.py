...
def markdown(summary, queue):
    ...
    lines += ['', '타워팰리스·SKY-L65의 완료는 명시된 주거타워에 한정합니다. 공용 저층부·스포츠센터·조경까지 완공 모델이라는 뜻이 아닙니다. 메이플은 일부 사진 대조 개선만 되어 전체 29동 완료가 아닙니다. 하이페리온은 공식 관리단지 2동과 제작한 A/B/C 3타워의 용도 배정 대조가 남아 완료를 보류합니다.', '',
        '## 위치·자료 한계와 재현', '',
