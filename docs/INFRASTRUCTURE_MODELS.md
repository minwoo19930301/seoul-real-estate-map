...
이 문서는 이전 390개 인프라 모델 추가분의 기록입니다. 당시 기존 1,160개에 더해 총 1,550개였고, 이 배치의 학교·공공기관·교량은 이후 확장에서도 유지했습니다. 현재 총 3,088개와 새 시청·문화시설·회사·100세대 이상 아파트는 [최신 확장 기록](CITY_EXPANSION_100.md)을 참고하세요.
...
| 당시 역 주변 버스 정류장 | 51개 노드 | 이후 서울시 공식 버스·따릉이 자료로 교체, [현행 범위](TRANSIT_COVERAGE.md) |
